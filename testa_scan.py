...
KOSPI_UNIVERSE = [
    ...
    ('161390', '한국타이어앤테크놀로지'), ('078930', 'GS'),
    # 51~100
    ('267250', 'HD현대'),            ('329180', 'HD현대중공업'),
    ('042660', '한화오션'),          ('079550', 'LIG디펜스앤에어로스페이스'),
